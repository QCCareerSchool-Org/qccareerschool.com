  ...
  <DefaultLayout>
      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="mb-4 md-md-0 order-1 order-md-2">
            <img src={MakeupWedding} alt="Private Group Discounts" className="sideImage" />
          </Col>
        </Row>
      </Container>
    </section>
      ...
      <Container>
        <Row>
          <Col xs={12} md={6} className="mb-4 md-md-0 ">
            <img src={DecorEvent} alt="Private Group Discounts" className="sideImage" />
          </Col>
    ...
    <section>
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="mb-4 md-md-0 order-1 order-md-2">
            <img src={DestinationTravel} alt="Private Group Discounts" className="sideImage" />
          </Col>
        </Row>
      </Container>
    </section>
    ...
    <section>
      <Container>
        <Row>
          <Col xs={12} md={6} className="mb-4 md-md-0 ">
            <img src={WriteMakeup} alt="Private Group Discounts" className="sideImage" />
          </Col>
          <Col xs={12} md={6} className="order-2 ">
    ...
    <section>
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="mb-4 md-md-0 order-1 order-md-2">
            <img src={DecorColor} alt="Private Group Discounts" className="sideImage" />
          </Col>
        </Row>
      </Container>
    </section>
    ...
    <section>
      <Container>
        <Row>
          <Col xs={12} md={6} className="mb-4 md-md-0 ">
            <img src={BusinessCommunications} alt="Private Group Discounts" className="sideImage" />
          </Col>
          <Col xs={12} md={6} className="order-2 ">
