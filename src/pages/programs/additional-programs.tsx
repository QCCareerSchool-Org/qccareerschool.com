        ...
        <Row>
          ...
          <Col xs={12} md={6} className="order-md-1">
            ...
            <div className="text-center">
              <Link href="https://www.winghill.com/"><a className="btn btn-secondary">Learn More</a></Link>
            </div>
          </Col>
        </Row>
      </Container>
      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="order-md-1">
            ...
            <div className="text-center">
              <Link href="https://www.qctravelschool.com/"><a className="btn btn-secondary">Learn More</a></Link>
            </div>
          </Col>
        </Row>
      </Container>
      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="order-md-1">
            ...
            <div className="text-center">
              <Link href="https://www.qcstyleacademy.com/"><a className="btn btn-secondary">Learn More</a></Link>
            </div>
          </Col>
        </Row>
      </Container>
