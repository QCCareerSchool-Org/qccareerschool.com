      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="order-md-1">
            ...
            <Link href="https://www.winghill.com/"><a className="btn btn-secondary btn-sm">Learn More</a></Link>
          </Col>
        </Row>
      </Container>
    </section>
      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="order-md-1">
            ...
            <Link href="https://www.qctravelschool.com/"><a className="btn btn-secondary btn-sm">Learn More</a></Link>
          </Col>
        </Row>
      </Container>
    </section>
      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={6} className="order-md-1">
            ...
            <Link href="https://www.qcstyleacademy.com/"><a className="btn btn-secondary btn-sm">Learn More</a></Link>
          </Col>
        </Row>
      </Container>
    </section>
